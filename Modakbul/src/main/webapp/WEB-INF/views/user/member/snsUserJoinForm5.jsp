   ...
   <form id="registerform">
      ...
      <div class="formfield">
         <input type="text" id="MEMBER_ID"maxlength="20"
            value="${beforeID }" disabled="disabled">
         <input type="hidden" id="MEMBER_ID" name="MEMBER_ID" maxlength="20"
            value="${beforeID }">
      </div>
      <div class="fieldlabel">
      ...
      <div class="formfield">
         ...
         <input type="hidden" id="MEMBER_PW" name="MEMBER_PW" maxlength="20"
      ...
      <div class="formfield">
         <input type="text" id="MEMBER_NAME" name="MEMBER_NAME" maxlength="20"
            value="${snsvo.name }" readonly="readonly">
      </div>
      ...
      <div class="formfield">
         <input type="text" id="MEMBER_EMAIL" name="MEMBER_EMAIL" value="${snsvo.email }" autocomplete="off" readonly="readonly">
      </div>
	<input type="hidden" name="MEMBER_SNS" value="${snsvo.MEMBER_SNS}">
      <div class="btnfield">
